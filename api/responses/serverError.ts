...
module.exports = function(data: any, options: any) {
    ...
    if (!(viewData instanceof Error) && typeof viewData === "object") {
        try {
            viewData = util.inspect(data, { depth: <any>null });
        } catch (e) {
            viewData = undefined;
        }
    }
    ...
    if (options.view) {
        ...
        return res.view(`500`, { data: viewData, title: `Server Error` }, (err: any, html: string) => {
